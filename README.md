# TheodoreAI Portfolio

A modern portfolio website built with Vue.js 3, featuring a 3D business card and responsive design. This is the main TheodoreAI.github.io repository.
...
2. Open your browser to `http://localhost:5173/` (or the next available port)
